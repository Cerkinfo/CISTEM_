...
export default function ({ show, close }) {
  ...
  return (
    <Modal isOpen={show} size="xl" unmountOnClose={true}>
      <Style>
        <ModalHeader className="flex flex-col gap-1"><H3>Add a new food</H3></ModalHeader>
        <ModalBody>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <InputText 
              name="Name"
              placeholder="Example : Sandwich Club"
              value={formData.Name}
              onChange={handleInputChange}
            />
            <InputText
              name="Ingredients"
              placeholder="Example : Bread, Ham, Cheese, Salad, Tomato"
            ...
            <InputText
              ...
              name="Image"
              placeholder="Example : sandwich-club.png"
